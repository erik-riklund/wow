...
--- @field registerEventListener? fun(self: plugin, eventName: string, listener: listener) "Registers a listener for a specified event, appending the plugin identifier to the listener identifier."
--- @field removeEventListener?   fun(self: plugin, eventName: string, identifier: string) "Removes a listener from a specified event, using the plugin identifier as a prefix."
