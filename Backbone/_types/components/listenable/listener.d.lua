...
---
--- Represents a listener that can be registered with a `listenable` component.
--- Each listener includes a callback function, a unique identifier for managing
--- the listener, and an optional persistence flag.
---
--- @class listener
