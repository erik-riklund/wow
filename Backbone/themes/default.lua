...
backbone.registerColorTheme('Backbone', {
  ...
  --
  errorFrameBorderColor = { 0.06, 0.07, 0.09 }, -- onyx
  errorFrameBackgroundColor = { 0.58, 0.20, 0.14 }, -- cognac
  errorFrameDismissLabelColor = { 1.0, 1.0, 1.0, 0.5 }, -- white (50 %)
  errorFrameContentColor = { 1.0, 1.0, 1.0, 0.85 }, -- white (85 %)
  --
