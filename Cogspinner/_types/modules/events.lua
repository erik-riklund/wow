...
--#region (type: event.instance)

--- @class event.instance
--- @field listen fun(self: event.instance, event: event.name, callback: function, callback_id: string?)
--- @field silence fun(self: event.instance, event: event.name, callback_id: string)

--#endregion

--#region (type: event.name)

--- @alias event.name "ACHIEVEMENT_EARNED"
